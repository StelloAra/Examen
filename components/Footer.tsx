...
export default function Footer() {
  return (
    <footer className="relative bg-linear-to-br from-gray-50 via-white to-gray-100 text-gray-900 overflow-hidden border-t border-gray-200">
      {/* Background Pattern */}
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                Join the AnimalZoo family and get exciting updates, special
                treats, and wild surprises delivered straight to your inbox!
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-md lg:max-w-none mx-auto lg:mx-0">
              <Input
                ...
                className="h-12 md:h-14 px-4 md:px-6 rounded-2xl bg-white border-gray-300 text-gray-900 placeholder:text-gray-500 focus:border-sky-500 focus:ring-sky-500/20 text-base md:text-lg shadow-sm"
              />
              <Button className="h-12 md:h-14 px-6 md:px-8 rounded-2xl bg-linear-to-r from-cyan-500 via-sky-500 to-blue-500 hover:from-cyan-600 hover:via-sky-600 hover:to-blue-600 text-white font-semibold transition-all duration-200 hover:scale-105 border-0 text-base md:text-lg whitespace-nowrap shadow-lg">
                Subscribe
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start space-x-3">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-linear-to-br from-cyan-500 via-sky-500 to-blue-500 rounded-2xl flex items-center justify-center">
                <Cat className="h-4 w-4 md:h-5 md:w-5 text-cyan" />
              </div>
              <div>
                <h2 className="text-xl md:text-2xl font-black">
                  <span className="bg-linear-to-r from-cyan-500 via-sky-500 to-blue-500 bg-clip-text text-transparent">
                    Animal Zoo
                  </span>
                </h2>
                <p className="text-xs md:text-sm text-gray-500">
                  Where Animals Come Alive Since 2019
                </p>
              </div>
            </div>

            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
              We&apos;re passionate about bringing the wonders of the animal
              world to life, blending imagination, adventure, and the beauty of
              nature into every moment.
            </p>
          ...
          <div className="space-y-4 md:space-y-6 text-center md:text-left">
            ...
            <ul className="space-y-2 md:space-y-3">
              {[
                { name: "Our Animals", href: "#" },
                { name: "Explore the Zoo", href: "#" },
                { name: "Locations", href: "#" },
                { name: "Careers", href: "#" },
              ].map((link, index) => (
                <li key={index}>
                  <Link
                    href={link.href}
                    className="text-gray-600 hover:text-sky-600 transition-colors duration-200 hover:translate-x-1 inline-block text-sm md:text-base"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div className="space-y-4 md:space-y-6 text-center md:text-left">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-start justify-center md:justify-start space-x-3">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-cyan-100 rounded-xl flex items-center justify-center mt-1">
              ...
              <div className="flex items-start justify-center md:justify-start space-x-3">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-cyan-100 rounded-xl flex items-center justify-center mt-1">
                  <Phone className="h-4 w-4 md:h-5 md:w-5 text-cyan-600" />
                </div>
                <div className="text-left">
                  <p className="text-gray-900 font-medium text-sm md:text-base">
                    +1 (555) 123-Pets
              ...
              <div className="flex items-start justify-center md:justify-start space-x-3">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-cyan-100 rounded-xl flex items-center justify-center mt-1">
                  <Pocket className="h-4 w-4 md:h-5 md:w-5 text-cyan-600" />
                </div>
                <div className="text-left">
        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4 md:space-x-6 text-gray-500 text-xs md:text-sm text-center">
              <p>&copy; 2026 AnimalZoo. All rights reserved.</p>
            ...
            <div className="flex items-center space-x-2 text-gray-500 text-xs md:text-sm">
              <Heart className="h-4 w-4 md:h-5 md:w-5 text-cyan-500" />
              <span>With love from Sweden</span>
            </div>
          </div>
        </div>
      </div>
